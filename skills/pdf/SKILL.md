...
name: pdf
description: >
  Comprehensive PDF document creation, editing, and manipulation with
  ReportLab. Supports cover pages, typography, charts, tables, multi-column
  layouts, and CJK content. Use when: creating PDF documents, generating
  reports, building forms, extracting PDF content. Triggers: PDF, create PDF,
  generate PDF, report, document, PDF generation.
metadata:
  author: Z.AI
  version: "1.0.0"

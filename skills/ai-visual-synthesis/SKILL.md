...
```
Before generating code, read this skill and apply the 8-Layer Architecture.
```
...
### 10 Creative UI Concepts (Dolphin Mode)
...
| Raw SKILL.md | https://raw.githubusercontent.com/marktantongco/ai-visual-synthesis/refs/heads/main/skill.md |
...
_AI Visual Synthesis // promptc OS v2026.3_

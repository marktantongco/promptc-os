...
description: >
  ...
  interfaces. Use when: the user asks for UI design, UX flows, information
  architecture, visual style direction, design systems/tokens, component specs,
  copy/microcopy, accessibility, or wants to generate/critique/refine frontend
  UI. Triggers: UI design, UX, interface, design system, component spec,
  accessibility, design tokens, wireframe, mockup.
metadata:
  author: Z.AI
  version: "1.0.0"
license: MIT

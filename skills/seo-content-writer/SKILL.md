...
description: >
  Create high-quality, SEO-optimized content that ranks in search engines.
  Applies on-page SEO best practices, keyword optimization, and content
  structure for maximum visibility and engagement. Use when: writing SEO
  content, creating blog posts, drafting optimized articles, content writing
  for search rankings. Triggers: SEO content, write article, blog post, SEO
  writing, optimized content, keyword optimization.
metadata:
  author: Z.AI
  version: "1.0.0"
license: MIT
